...
/**
 * An event which is created to signal about the changes with a {@code PropertyHolder}. 
 *
 */
...
public class PropertyEvent {
	...
	/**
	 * Constructs an event that has happened because of {@code source}, resulting 
	 * in an action taken on the {@code property}.
