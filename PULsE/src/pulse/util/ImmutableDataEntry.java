...
/**
 * A {@code DataEntry} is an immutable ordered pair of an instance of  {@code T}, which is considered to be the 'key',
 * and an instance of {@code R}, which is considered to be the 'value'. 
 * @param <T> the key
 * @param <R> the value
 */
