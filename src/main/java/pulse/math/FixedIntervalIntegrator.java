...
public abstract class FixedIntervalIntegrator extends AbstractIntegrator {
	...
	/**
	 * Sets the number of integration segments and re-evaluates the integration step
	 * size.
	 * 
	...
	/**
	 * Retrieves the step size equal to the integration range length divided by the
