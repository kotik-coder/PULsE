...
/**
 * <p>
 * This is a general class for {@code Vector} operations useful for optimisers
 * and ODE solvers.
 * </p>
 */
public class Vector implements Serializable {
     ...
     * which are inverted, i.e. <math><i>b</i><sub>i</sub> =
     * -<i>a</i><sub>i</sub></math>.
     *
    ...
    /**
     * Calculates the squared distance from {@code this Vector} to {@code v}
     * (which is the squared length of the connecting {@code Vector}).
     *
