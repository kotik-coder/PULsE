...
/**
 * A {@code Segment} is simply a pair of values {@code a} and {@code b} 
 * such that {@code a < b}.
 *
 */
...
public class Segment2D {
	...
	/**
	 * Sets the minimum value to {@code a}. Note it does not prevent 
	 * against: {@code a >= max}.
	...
	/**
	 * Sets the maximum value to {@code b}. Note it does not prevent 
	 * against: {@code b <= min}.
	...
	/**
	 * Calculates a random value confined in the interval between
	 * the two ends of this {@code Segment}.
