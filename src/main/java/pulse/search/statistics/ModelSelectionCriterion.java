...
public abstract class ModelSelectionCriterion extends Statistic {
    ...
    /**
     * This calculates either the AIC or BIC statistic, which only differ by the
     * penalising term.
     *
     * @see penalisingTerm()
     */
    ...
    /**
     * Calculates the weight (in the Akaike sense) when comparing the model
     * associated with this statistic with other models represented by
     * statistics of the same type.
     *
     * @param the selection statistics of the same type as this one
     * @return a {@code NumericProperty} of the {@code MODEL_WEIGHT} type, which
     * is the probability this model is the best one.
     */
    ...
    /**
     * Calculates the probability that this model is the best among {@code all}
     * others.
     *
