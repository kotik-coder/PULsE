...
public class PulseMainMenu extends JMenuBar {
	...
	private void initComponents() {        
        ...
        modelSettingsItem = new JMenuItem("Heat Problem: Statement & Solution", Launcher.loadIcon("heat_problem.png", ICON_SIZE));
        searchSettingsItem = new JMenuItem("Parameter Estimation: Method & Settings", Launcher.loadIcon("inverse_problem.png", ICON_SIZE));
