...
public class ResourceMonitor {
	 ...
	 * this is rather code-intensive, so it is recommended for use only at certain
	 * time intervals.
	 * </p>
	 *
	 */
	 ...
	 * several tasks in parallel. The number of threads is greater or equal to the number of
	 * cores
