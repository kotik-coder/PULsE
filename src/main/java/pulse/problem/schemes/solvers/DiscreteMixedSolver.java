...
public class DiscreteMixedSolver extends MixedCoupledSolver {

	public DiscreteMixedSolver() {
		super();
	}

	public DiscreteMixedSolver(NumericProperty N, NumericProperty timeFactor) {
		super(N, timeFactor);
	}

	public DiscreteMixedSolver(NumericProperty N, NumericProperty timeFactor, NumericProperty timeLimit) {
	...
	public DifferenceScheme copy() {
		return new DiscreteMixedSolver(grid.getGridDensity(),
