...
public class ADILayeredSolver extends ADIScheme implements Solver<CoreShellProblem> {
	...
	private final static NumericProperty SHELL_GRID_DENSITY = 
			NumericProperty.derive(NumericPropertyKeyword.SHELL_GRID_DENSITY, 10);
	...
	public ADILayeredSolver(NumericProperty nCore, NumericProperty nShell, NumericProperty timeFactor, NumericProperty timeLimit) {
