...
public class NewtonCotesQuadrature extends CompositionProduct {
	...
	/**
	 * Constructs a default {@code NewtonCotesQuadrature} with integration bounds spanning from 0 to 1.
	 */
	...
	/**
	 * Constructs a default {@code NewtonCotesQuadrature} whose integration bounds are specified by the argument.
	...
	/**
	 * Constructs a custom {@code NewtonCotesQuadrature} with specified integration bounds and number of integration segments.
	 * The underlying integration scheme by default is a {@code SimpsonIntegrator}.
	 * @param bounds the integration bounds
	 * @param segments the number of integration segments. The higher this number, the higher is the accuracy.
