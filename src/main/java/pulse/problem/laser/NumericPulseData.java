...
/**
 * An instance of the {@code AbstractData} class, which also declares an {@code externalID}.
 * Use to store numeric data of the pulse for each measurement imported from an external source.
 *
 */
