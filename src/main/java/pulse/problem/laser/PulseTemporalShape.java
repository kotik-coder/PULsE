...
/**
 * An abstract time-dependent pulse shape. Declares the abstract method to calculate the laser power function
 * at a given moment of time. This generally utilises a discrete pulse width.
 *
 */
