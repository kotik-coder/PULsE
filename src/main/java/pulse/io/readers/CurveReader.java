...
public interface CurveReader extends AbstractReader<List<ExperimentalData>> {
    ...
    /**
     * Basic operation for reading the {@code file} and converting this to a
     * {@code List} of {@code ExperimentalData} objects.
     * <p>
     *
     * @param file a {@code File} which has <b>either</b> all information
     * encoded in its contents <b>or</b> provides {@code URI} links to other
     * files, each containing the necessary information.
     * @return
     * <p>
     * a {@code List} of {@code ExperimentalData} objects associated with this
     * {@code file}. In case if {@code file} contains only one
     * {@code ExperimentalData}, i.e. if the data is only presented for one
     * heating curve taken at a specific temperature after a single laser shot,
     * the size of the {@code List} will be equal to unity.
     * </p>
