...
public interface DatasetReader extends AbstractReader {
	
	/**
	 * Creates an {@code InterpolationDataset} using the dataset stored in
	 * the {@code file}.
	 * @param file a file with a supported extension containing the information
	 * needed to create an {@code InterpolationDataset}.  
	 * @return an {@code InterpolationDataset}, which not only stores the information
	 * contained in {@code file}, but also provides means of interpolation.
