...
public enum NumericPropertyKeyword {
    ...
    DIAMETER,
    /**
     * The maximum temperature, or the signal height -- if a relative
    ...
    HEAT_LOSS_SIDE,
    /**
     * The coefficient of heat losses from the front and rear surfaces of the
     ...
     * Biot numbers, will differ due to different areas of the side and
     * front/rear surfaces.
     */
    HEAT_LOSS_COMBINED,
    /**
    ...
    ITERATION_LIMIT,
    /**
     * Dimensionless coefficient of laser energy absorption
     * (&gamma;<sub>0</sub>).
     */
    LASER_ABSORPTIVITY,
    /**
    ...
    /**
     * A directive to the optimiser informing both front and rear side
     * absorptivities must be equal.
     */
    ...
    PLANCK_NUMBER,
    /**
     * The optical thickness of a material, equal to a product of its geometric
     * thickness and the absorptivity.
     */
    OPTICAL_THICKNESS,
    /**
